                    ...
                    <div class="row card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="open_date" value="{{ old('Open_date') }}" class="form-control" id="Open_date"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="tables" value="{{ old('Tables') }}"
                                    class="form-control" id="tables" placeholder="Tables">
                                @error('tables')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
