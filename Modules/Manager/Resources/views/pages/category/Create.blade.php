    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h3 class="m-0 text-muted">New Category</h3>
                        <li>
                    ...
                    <div class="row card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="{{ $locale }}[name]"
                                        value="{{ old($locale . '.name') }}" class="form-control" id="Name"
                                        placeholder="@lang('trans.'.$locale.'.name')">
                                    @error($locale . '.name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="char" name="price" value="{{ old('price') }}" class="form-control"
