                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <a href="{{ route('chef.index') }}" class="btn btn-info btn-sm">Chefs</a>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="row card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="mobile" value="{{ $chef->mobile }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="national_id" value="{{ $chef->national_id }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="salary_id" id="" class="form-control">
                                    ...
                                    @foreach ($salaries as $salary)
                                        <option {{ $chef->salary->id == $salary->id ? 'selected' : '' }}
                            ...
                            <div class="form-group">
                                ...
                                <select name="branch_id" id="" class="form-control">
                                    ...
                                    @foreach ($branches as $branch)
                                        <option {{ $chef->branch->id == $branch->id ? 'selected' : '' }}
                            ...
                            <div class="form-group">
                                ...
                                <input name="join_date" value="{{ $chef->join_date }}" type="date"
