    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h3 class="m-0 text-muted">Update Offer</h3>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="row card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ $offer->name }}" class="form-control" id="Name"
                                    placeholder="Name">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="end_at" value="{{ $offer->end_at }}" class="form-control"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="percentage" value="{{ $offer->percentage }}"
