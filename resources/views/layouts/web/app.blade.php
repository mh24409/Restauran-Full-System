...
<head>
    ...
    <!-- vurWizerd -->
    <link rel="stylesheet" href="{{ asset('web_files/assets/css/vueFormWizerd.css') }}">
    <link rel="stylesheet" href="{{ asset('web_files/assets/css/themify-icons.css') }}">
</head>

<body class="menu-landding ">
